...
import com.base.refresh.R;
import com.base.refresh.resh.api.DefaultRefreshFooterCreater;
import com.base.refresh.resh.api.DefaultRefreshHeaderCreater;
...
import com.base.refresh.resh.api.RefreshKernel;
import com.base.refresh.resh.api.RefreshLayout;
import com.base.refresh.resh.api.ScrollBoundaryDecider;
import com.base.refresh.resh.constant.DimensionStatus;
import com.base.refresh.resh.constant.RefreshState;
import com.base.refresh.resh.constant.SpinnerStyle;
import com.base.refresh.resh.footer.BallPulseFooter;
import com.base.refresh.resh.header.BezierRadarHeader;
import com.base.refresh.resh.header.FalsifyHeader;
import com.base.refresh.resh.impl.RefreshContentWrapper;
import com.base.refresh.resh.impl.RefreshFooterWrapper;
import com.base.refresh.resh.impl.RefreshHeaderWrapper;
import com.base.refresh.resh.listener.OnLoadmoreListener;
...
import com.base.refresh.resh.util.DelayedRunable;
import com.base.refresh.resh.util.DensityUtil;
import com.base.refresh.resh.util.ViscousFluidInterpolator;
...
import static com.base.refresh.resh.util.DensityUtil.dp2px;
...
public class SmartBannerRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    public SmartBannerRefreshLayout(Context context) {
        super(context);
        this.initView(context, null);
    }

    public SmartBannerRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public SmartBannerRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public SmartBannerRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        }
    ...
    @Override
    public SmartBannerRefreshLayout setFooterHeight(float heightDp) {
        return setFooterHeightPx(dp2px(heightDp));
    }

    @Override
    public SmartBannerRefreshLayout setFooterHeightPx(int heightPx) {
    ...
    @Override
    public SmartBannerRefreshLayout setHeaderHeight(float heightDp) {
        return setHeaderHeightPx(dp2px(heightDp));
    }

    @Override
    public SmartBannerRefreshLayout setHeaderHeightPx(int heightPx) {
    ...
    @Override
    public SmartBannerRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public SmartBannerRefreshLayout setHeaderMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setFooterMaxDragRate(float rate) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setReboundInterpolator(Interpolator interpolator) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableLoadmore(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableRefresh(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableHeaderTranslationContent(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableFooterTranslationContent(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableAutoLoadmore(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableOverScrollBounce(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnablePureScrollMode(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setEnableLoadmoreWhenContentNotFull(boolean enable) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setRefreshHeader(RefreshHeader header) {
        if (header != null) {
            if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setRefreshHeader(RefreshHeader header, int width, int height) {
        if (header != null) {
            if (mRefreshHeader != null) {
                removeView(mRefreshHeader.getView());
            }
     ...
     */
    @Override
    public SmartBannerRefreshLayout setRefreshFooter(RefreshFooter footer) {
        if (footer != null) {
            if (mRefreshFooter != null) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setRefreshFooter(RefreshFooter footer, int width, int height) {
        if (footer != null) {
            if (mRefreshFooter != null) {
                removeView(mRefreshFooter.getView());
            }
     ...
     */
    @Override
    public SmartBannerRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public SmartBannerRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setOnLoadmoreListener(OnLoadmoreListener listener) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadmoreListener = listener;
        this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
        return this;
     ...
     */
    @Override
    public SmartBannerRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setPrimaryColors(int... colors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout setLoadmoreFinished(boolean finished) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishLoadmore() {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastRefreshingTime;
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Refreshing) {
                    if (mRefreshHeader != null) {
                        int startDelay = mRefreshHeader.onFinish(SmartBannerRefreshLayout.this, success);
                        notifyStateChanged(RefreshState.RefreshFinish);
                        if (mOnMultiPurposeListener != null) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishLoadmore(int delayed) {
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishLoadmore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastLoadingTime;
     ...
     */
    @Override
    public SmartBannerRefreshLayout finishLoadmore(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading) {
                    if (mRefreshFooter != null && mKernel != null && mRefreshContent != null) {
                        int startDelay = mRefreshFooter.onFinish(SmartBannerRefreshLayout.this, success);
                        if (startDelay == Integer.MAX_VALUE) {
                            return;
                        }
                        notifyStateChanged(RefreshState.LoadFinish);
    ...
    protected class RefreshKernelImpl implements RefreshKernel {
        ...
        public RefreshLayout getRefreshLayout() {
            return SmartBannerRefreshLayout.this;
        }

        @NonNull
        @Override
        public RefreshContent getRefreshContent() {
            return SmartBannerRefreshLayout.this.mRefreshContent;
        }

        //<editor-fold desc="状态更改 state changes">
        public RefreshKernel setStatePullUpToLoad() {
            SmartBannerRefreshLayout.this.setStatePullUpToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToLoad() {
            SmartBannerRefreshLayout.this.setStateReleaseToLoad();
            return this;
        }

        public RefreshKernel setStateReleaseToRefresh() {
            SmartBannerRefreshLayout.this.setStateReleaseToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownToRefresh() {
            SmartBannerRefreshLayout.this.setStatePullDownToRefresh();
            return this;
        }

        public RefreshKernel setStatePullDownCanceled() {
            SmartBannerRefreshLayout.this.setStatePullDownCanceled();
            return this;
        }

        public RefreshKernel setStatePullUpCanceled() {
            SmartBannerRefreshLayout.this.setStatePullUpCanceled();
            return this;
        }

        public RefreshKernel setStateLoding() {
            SmartBannerRefreshLayout.this.setStateLoding();
            return this;
        }

        public RefreshKernel setStateRefresing() {
            SmartBannerRefreshLayout.this.setStateRefresing();
            return this;
        }

        @Override
        public RefreshKernel setStateLodingFinish() {
            SmartBannerRefreshLayout.this.setStateLodingFinish();
            return this;
        }

        @Override
        public RefreshKernel setStateRefresingFinish() {
            SmartBannerRefreshLayout.this.setStateRefresingFinish();
            return this;
        }

        public RefreshKernel resetStatus() {
            SmartBannerRefreshLayout.this.resetStatus();
            return this;
        }
        //</editor-fold>
        ...
        public RefreshKernel overSpinner() {
            SmartBannerRefreshLayout.this.overSpinner();
            return this;
        }

        public RefreshKernel moveSpinnerInfinitely(float dy) {
            SmartBannerRefreshLayout.this.moveSpinnerInfinitely(dy);
            return this;
        }

        public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
            SmartBannerRefreshLayout.this.moveSpinner(spinner, isAnimator);
            return this;
        }

        public RefreshKernel animSpinner(int endSpinner) {
            SmartBannerRefreshLayout.this.animSpinner(endSpinner);
            return this;
        }

        @Override
        public RefreshKernel animSpinnerBounce(int bounceSpinner) {
            SmartBannerRefreshLayout.this.animSpinnerBounce(bounceSpinner);
            return this;
        }
